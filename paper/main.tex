...
Figure~\ref{fig:architecture} shows the end-to-end system architecture used in the repository, from market data ingestion and feature generation through temporal-relational forecasting, walk-forward training, and portfolio-level evaluation.

\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{architecture_tikz.pdf}
\caption{End-to-end architecture of the implemented NIFTY 100 cross-sectional forecasting system.}
